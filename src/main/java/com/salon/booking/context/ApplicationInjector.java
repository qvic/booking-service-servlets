...
import com.salon.booking.command.admin.ShowUsersByPagesCommand;
...
public final class ApplicationInjector {
    ...
    private static final OrderService ORDER_SERVICE = new OrderServiceImpl(TIMESLOT_SERVICE, ORDER_DAO, SERVICE_DAO, USER_DAO, ORDER_MAPPER, SERVICE_MAPPER, TRANSACTION_MANAGER);
